...
def tournament_winner(competitions: [[str, str]], results: [int]) -> str:
    """
    Given a list of competitions and results, find the winner of the tournament.
    """
    scores = {}
    winner = ""
    winner_points = 0
    for i, teams in enumerate(competitions):
        if results[i] == 1:
            if teams[0] in scores:
                ...
                scores[teams[0]] = 3
            if scores[teams[0]] > winner_points:
                winner_points = scores[teams[0]]
                winner = teams[0]
        else:
            if teams[1] in scores:
                ...
                scores[teams[1]] = 3
            if scores[teams[1]] > winner_points:
                winner_points = scores[teams[1]]
                winner = teams[1]
    return winner
