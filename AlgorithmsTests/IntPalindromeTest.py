...
class IntPalindromeTest(unittest.TestCase):
    ...
    def testIntPalindrome(self):
        actual_result = IntPalindrome().is_palindrome(12345654321)
        self.assertEqual(actual_result, True)

    def testEvenIntPalindrome(self):
        actual_result = IntPalindrome().is_palindrome(1234554321)
        self.assertEqual(actual_result, True)

    def testZeroIntPalindrome(self):
        actual_result = IntPalindrome().is_palindrome(0)
        self.assertEqual(actual_result, True)

    def testOneIntPalindrome(self):
        actual_result = IntPalindrome().is_palindrome(1)
        self.assertEqual(actual_result, True)

    def testEmptyIntPalindrome(self):
        actual_result = IntPalindrome().is_palindrome()
        self.assertEqual(actual_result, False)

    def testNoneIntPalindrome(self):
        actual_result = IntPalindrome().is_palindrome(None)
        self.assertEqual(actual_result, False)
    ...
    def testFalseIntPalindrome(self):
        actual_result = IntPalindrome().is_palindrome(1234)
        self.assertEqual(actual_result, False)
